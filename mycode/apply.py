...
from score_functions import score_ruleConfidence_timediffReward
...
rules_dict = ra.filter_rules(
    rules_dict, min_conf=0, min_body_supp=0, rule_lengths=rule_lengths
)
...
score_func = score_12
# score_func = score_ruleConfidence_timediffReward
